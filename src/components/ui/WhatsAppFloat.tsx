...
export default function WhatsAppFloat() {
  return (
    <a
      href="https://wa.me/919897580016?text=Hello%2C%20I%20would%20like%20to%20enquire%20about%20a%20stay%20at%20Shubharambh%20Hotel%20Pithoragarh."
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat on WhatsApp"
      className="fixed bottom-8 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-200"
    >
      <svg
        viewBox="0 0 24 24"
        width="28"
